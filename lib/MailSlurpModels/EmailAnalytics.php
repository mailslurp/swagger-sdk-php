...
/**
 * EmailAnalytics Class Doc Comment
 *
 * @category Class
 * @description Analysis of an email message and its contents
 * @package  MailSlurpSDK
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EmailAnalytics implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EmailAnalytics';
    ...
    protected static $swaggerFormats = [
        'spam_negativity_percentage' => 'int32'
    ];
    ...
    protected static $attributeMap = [
        'spam_negativity_percentage' => 'spamNegativityPercentage'
    ];
    ...
    protected static $setters = [
        'spam_negativity_percentage' => 'setSpamNegativityPercentage'
    ];
    ...
    protected static $getters = [
        'spam_negativity_percentage' => 'getSpamNegativityPercentage'
    ];
    ...
    {
        $this->container['spam_negativity_percentage'] = isset($data['spam_negativity_percentage']) ? $data['spam_negativity_percentage'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['spam_negativity_percentage'] === null) {
            $invalidProperties[] = "'spam_negativity_percentage' can't be null";
        }
    ...
    /**
     * Gets spam_negativity_percentage
     *
     * @return int
     */
    public function getSpamNegativityPercentage()
    {
        return $this->container['spam_negativity_percentage'];
    }

    /**
     * Sets spam_negativity_percentage
     *
     * @param int $spam_negativity_percentage spam_negativity_percentage
     *
     * @return $this
     */
    public function setSpamNegativityPercentage($spam_negativity_percentage)
    {
        $this->container['spam_negativity_percentage'] = $spam_negativity_percentage;
