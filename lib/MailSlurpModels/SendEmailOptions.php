...
class SendEmailOptions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SendEmailOptions';
     ...
     * Sets bcc
     *
     * @param string[] $bcc Optional list of bcc destination email addresses
     *
     * @return $this
     */
     ...
     * Sets cc
     *
     * @param string[] $cc Optional list of cc destination email addresses
     *
     * @return $this
     */
     ...
     * Sets from
     *
     * @param string $from Optional from address. If not set source inbox address will be used
     *
     * @return $this
     */
     ...
     * Sets reply_to
     *
     * @param string $reply_to Optional replyTo header
     *
     * @return $this
     */
